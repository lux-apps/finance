      ...
      <footer className="py-12 px-6 border-t border-border">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h4 className="font-bold mb-4">LUX BANK</h4>
              <p className="text-muted-foreground text-sm">
                Self-custody banking for the modern world.
              </p>
            </div>
            <div>
              <h4 className="font-bold mb-4">Products</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href="#accounts" className="hover:text-foreground transition-colors">Accounts</Link></li>
                <li><Link href="#cards" className="hover:text-foreground transition-colors">Cards</Link></li>
                <li><Link href="#transfers" className="hover:text-foreground transition-colors">Transfers</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-4">Ecosystem</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href="/" className="hover:text-foreground transition-colors">Lux Finance</Link></li>
